...
resource "azurerm_virtual_desktop_application_group" "ra" {
  ...
  friendly_name = "Secure Apps"
  description   = "Pixel Streamed Secure Apps"
...
resource "azurerm_virtual_desktop_application" "acrobat" {
 name                         = "AdobeAcrobat"
 application_group_id         = azurerm_virtual_desktop_application_group.ra.id
 friendly_name                = "Adobe Acrobat"
...
resource "azurerm_virtual_desktop_application" "teams" {
 name                         = "MicrosoftTeams"
 application_group_id         = azurerm_virtual_desktop_application_group.ra.id
 ...
 command_line_argument_policy = "DoNotAllow"
 show_in_portal               = false
 icon_path                    = "C:\\Program Files (x86)\\Microsoft\\Teams\\current\\Teams.exe"
 icon_index                   = 0
}

resource "azurerm_virtual_desktop_application" "onenote" {
 name                         = "OneNote"
 application_group_id         = azurerm_virtual_desktop_application_group.ra.id
 friendly_name                = "Microsoft OneNote"
 description                  = "Microsoft OneNote"
 path                         = "C:\\Program Files\\Microsoft Office\\root\\Office16\\ONENOTE.EXE"
 command_line_argument_policy = "DoNotAllow"
 show_in_portal               = false
 icon_path                    = "C:\\Program Files\\Microsoft Office\\root\\Office16\\ONENOTE.EXE"
 icon_index                   = 0
}
...
resource "azurerm_virtual_desktop_application" "outlook" {
 ...
 description                  = "MicrosoFt Outlook for Army EMAIL"
...
resource "azurerm_subnet" "subnet" {
  ...
  resource_group_name  = "CAZ-MANAGE-P-RGP-CrossTenant"
...
resource "azurerm_role_assignment" "role_ra" {
  scope              = azurerm_virtual_desktop_application_group.ra.id
